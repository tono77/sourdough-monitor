"""Bread window detection — fires when growth crosses 100% (doubled).

The "bread window" is the optimal time to use the sourdough for baking:
- Opens when crecimiento_pct >= 100% (sourdough has doubled)
- Closes when crecimiento_pct drops below 100% after having been above
...
THRESHOLD = 100.0  # 100% growth = doubled
